...
const ko = {
  ...
  'settings.githubHint': '기여와 이슈 제보를 환영합니다.',

  // study panel
  'study.toc': '학습 목차',
  'study.generating': '요약 문서를 작성하고 있습니다…',
  'study.writing': '작성 중…',
  'study.regenerateSection': '다시 만들기',
  'study.regenerating': '생성 중…',
  ...
  'settings.aiProviderHint': 'GPT, Gemini는 추후 추가될 예정입니다.',
...
const en: Record<keyof typeof ko, string> = {
  ...
  'settings.github': 'GitHub',
  'settings.githubHint': 'Contributions and issue reports are welcome.',

  'study.toc': 'Contents',
  'study.generating': 'Writing the summary document…',
  'study.writing': 'Writing…',
  'study.regenerateSection': 'Regenerate',
  'study.regenerating': 'Generating…',
  ...
  'settings.aiProviderHint': 'GPT and Gemini support is planned for a future update.',
